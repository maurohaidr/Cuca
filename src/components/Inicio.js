...
{/*             <button className = 'button' onClick = {() => toggle()} >Start</button>   */}
          ...
          <div className = 'cucaBlock'>
            <button className = 'cuca' onClick={() =>handleHit()} style={{position: 'absolute', bottom: (props.cucaPos.x), right: props.cucaPos.y}}><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-bug" viewBox="0 0 16 16">
